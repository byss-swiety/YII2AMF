...
class Gateway {
     ...
     */
    public function  __construct(array $getData, array $postData, $rawInputData, $contentType, Config $config = null) {
    ...
    public function service(){
        ...
        $deserializedResponse = null;
         ...
         try{
            ...
            PluginManager::getInstance()->loadPlugins($this->config->pluginsFolders, $this->config->pluginsConfig, $this->config->sharedConfig, $this->config->disabledPlugins);

             $defaultHandler = new \amf\core\amf\Handler($this->config->sharedConfig);
            ...
            $serviceRouter = new \amf\core\common\ServiceRouter($this->config->serviceFolders, $this->config->serviceNames2ClassFindInfo, $this->config->checkArgumentCount);
