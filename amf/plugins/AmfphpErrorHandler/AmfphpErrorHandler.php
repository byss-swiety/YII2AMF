...
namespace amf\plugins\AmfphpErrorHandler;
...
class AmfphpErrorHandler {
    ...
    public function  __construct(array $config = null) {
        set_error_handler('\amf\plugins\AmfphpErrorHandler\AmfphpErrorHandler::custom_warning_handler');
    }
