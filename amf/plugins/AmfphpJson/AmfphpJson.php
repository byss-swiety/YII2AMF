 ...
 */
namespace amf\plugins\AmfphpJson;
use amf\core\Config;
 ...
 */
class AmfphpJson implements IDeserializer, IDeserializedRequestHandler, IExceptionHandler, ISerializer {
    /**
     ...
     * @see Config::CONFIG_RETURN_ERROR_DETAILS
     * @var boolean
     */
