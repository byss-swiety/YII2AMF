...
namespace amf\plugins\AmfphpCharsetConverter;
...
class AmfphpCharsetConverter {
    ...
    public function  __construct(array $config = null) {
        ...
        $filterManager->addFilter(\amf\core\Gateway::FILTER_DESERIALIZED_REQUEST, $this, 'filterDeserializedRequest');
        $filterManager->addFilter(\amf\core\Gateway::FILTER_DESERIALIZED_RESPONSE, $this, 'filterDeserializedResponse');
    }
    ...
    public function filterDeserializedRequest($deserializedRequest){
        $deserializedRequest = \amf\core\amf\Util::applyFunctionToContainedObjects($deserializedRequest, array($this, 'convertStringFromClientToPhpCharsets'));
    ...
    public function filterDeserializedResponse($deserializedResponse){
        $deserializedResponse = amf\core\amf\Util::applyFunctionToContainedObjects($deserializedResponse, array($this, 'convertStringFromPhpToClientCharsets'));
        if(class_exists('AmfphpMonitor', false)){
