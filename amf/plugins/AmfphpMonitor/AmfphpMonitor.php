...
namespace amf\plugins\AmfphpMonitor;
use amf\core\Config;
...
use amf\plugins\AmfphpMonitor\AmfphpMonitorService;
...
class AmfphpMonitor {
    ...
    public function __construct(array $config = null) {
        ...
        $filterManager->addFilter(Gateway::FILTER_SERVICE_NAMES_2_CLASS_FIND_INFO, $this, 'filterServiceNames2ClassFindInfo');
        ...
        $filterManager->addFilter(Gateway::FILTER_DESERIALIZED_REQUEST, $this, 'filterDeserializedRequest', 0);
        $filterManager->addFilter(Gateway::FILTER_DESERIALIZED_RESPONSE, $this, 'filterDeserializedResponse', 0);
    ...
    public function filterServiceNames2ClassFindInfo(array $serviceNames2ClassFindInfo) {
        $serviceNames2ClassFindInfo['AmfphpMonitorService'] = new \amf\core\common\ClassFindInfo(dirname(__FILE__) . '/AmfphpMonitorService.php', '\amf\plugins\AmfphpMonitor\AmfphpMonitorService');
