...
class AmfphpDiscoveryService {
    ...
    public function discover() {
        ...
        foreach ($serviceNames as $serviceName) {
            $serviceObject = \amf\core\common\ServiceRouter::getServiceObjectStatically($serviceName, self::$serviceFolders, self::$serviceNames2ClassFindInfo);
            ...
            foreach ($methodRs as $methodR) {
                ...
                foreach ($paramRs as $paramR) {
                    ...
                    $parameterInfo = new \amf\plugins\AmfphpDiscovery\ParameterDescriptor($parameterName, $type, $example);
                ...
                $methods[$methodName] = new \amf\plugins\AmfphpDiscovery\MethodDescriptor($methodName, $parameters, $methodComment, $return);
            }

            $ret[$serviceName] = new \amf\plugins\AmfphpDiscovery\ServiceDescriptor($serviceName, $methods, $objComment);
        }
