...
namespace amf\plugins\AmfphpDiscovery;

use amf\plugins\AmfphpDiscovery\AmfphpDiscoveryService;
use amf\plugins\AmfphpDiscovery\MethodDescriptor;
use amf\plugins\AmfphpDiscovery\ParameterDescriptor;
use amf\plugins\AmfphpDiscovery\ServiceDescriptor;
...
class AmfphpDiscovery {
    ...
    */
    ...
    public function  __construct(array $config = null) {
        $filterManager = \amf\core\FilterManager::getInstance();
        $filterManager->addFilter(\amf\core\Gateway::FILTER_SERVICE_NAMES_2_CLASS_FIND_INFO, $this, 'filterServiceNames2ClassFindInfo', 99);
        $filterManager->addFilter(\amf\core\Gateway::FILTER_SERVICE_FOLDER_PATHS, $this, 'filterServiceFolderPaths', 99);
    ...
    public function filterServiceNames2ClassFindInfo(array $serviceNames2ClassFindInfo){
        $serviceNames2ClassFindInfo['AmfphpDiscoveryService'] = new \amf\core\common\ClassFindInfo( dirname(__FILE__) . '/AmfphpDiscoveryService.php', 'amf\plugins\AmfphpDiscovery\AmfphpDiscoveryService');
